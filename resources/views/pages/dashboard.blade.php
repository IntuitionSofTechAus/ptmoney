                    ...
                    <div class="card card-stats">
                        <div class="card-body ">
                            <div class="row">
                                ...
                                <div class="col-8 col-md-9">
                                    <div class="numbers">
                                        <p class="card-category">Add New Transaction</p>
                                        <!-- <p class="card-title">{{ \App\Models\User::where('is_verified',1)->get()->count() ?? '' }}
                                            <p> -->
                                            <p class="card-title"><a href="{{route('new-transaction')}}" class="btn btn-success btn-sm"><i class="fa fa-exchange "></i></a>
                                            </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-8 col-md-9">
                                    <div class="numbers">
                                        ...
                                        <!-- p class="card-title">{{ \App\Models\Sender::where('user_id','!=',Auth::user()->id)->get()->count() ?? '' }}
                                            <p> -->
                                            <p class="card-title"><a href="{{route('customer.new')}}" class="btn btn-danger btn-sm"><i class="fa fa-users "></i></a>
                                            </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body ">
                            <div class="row">
                                ...
                                <div class="col-7 col-md-8">
                                    <div class="numbers">
                                        <p class="card-category">Member List</p>
                                        <p class="card-title">{{\App\Models\Sender::where('user_id','=',Auth::user()->id)->get()->count() ?? ''}}
                                            </p>
                                    </div>
                                </div>
                                ...
                                @if(count($transaction) > 0)
                                    @foreach($transaction as $k=>$t)
                                        <tr>
                                            ...
                                            <td>@if(Auth::user()->role_id == 1)<a href="{{route('transaction.mail',$t->id)}}" class="btn btn-info btn-round"><i class="fa fa-envelope" aria-hidden="true"></i></a>@endif <a href="{{route('transaction.detail',$t->id)}}" class="btn btn-success btn-round"><i class="fa fa-money" aria-hidden="true"></i></a></td>
                                        </tr>
                                    @endforeach
                                <!-- @endif -->
                            </tbody>
