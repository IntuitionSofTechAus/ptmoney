        ...
        <div class="row">
            ...
            <div class="credits ml-auto">
                <span class="copyright">
                    ...
                    </script>{{ __(', made with ') }}<i class="fa fa-heart heart"></i>{{ __(' by ') }}<a class="@if(Auth::guest()) text-white @endif" href="javascript:void(0)" target="_blank">{{ __('Intuition SofTech Australia') }}</a>
                </span>
            </div>
        </div>
    </div>
